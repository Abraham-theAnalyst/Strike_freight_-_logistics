...
export const metadata: Metadata = pageMetadata({
  title: "How It Works: Sending & Receiving Parcels",
  description:
    "How Strike Freight & Logistics works: get a quote on WhatsApp, drop off at our Ogba office or request pickup, then track your shipment until it lands, anywhere in the world.",
  path: "/how-it-works",
});
